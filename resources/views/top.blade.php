    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ $active == 'pemasukan' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('pemasukans.index') }}">
            ...
            <li class="nav-item {{ $active == 'pengeluaran' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('pengeluarans.index') }}">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    ...
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user() ? Auth::user()->name : 'Kakek' }}</span>
